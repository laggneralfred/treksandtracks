...
For more information read **[Review, Tutorials, FAQ](http://mypgc.co/ "Grand Flagallery Home Page")** and see demos created with "Grand Flagallery" WordPress Plugin.

Image Link support now available in gallery skins. [See Slider Skin demo](http://mypgc.co/portfolio-item/flagallery-slider-skin/).
...
GRAND Pages - Full Window Gallery Template. You can display your image gallery in full window separate page (gallery template). [View Demo 1](http://mypgc.co/flagallery/photopro-gallery-page/), [View Demo 2](http://mypgc.co/flagallery/sphere-gallery-page/)
...
Added music playlist support in image gallery skins. Now your visitors can listen music while watching gallery. [View Demo](http://mypgc.co/flagallery/optima-gallery-page/)

Now you can see "Views" of each photo in the gallery and visitors can "Like" image and see image "Rating".

* Demo [Photo Galleries](http://mypgc.co/portfolio/)
* Demo [Full Window Gallery Template](http://mypgc.co/flagallery/optima-gallery-page/)
* Demo [Video Galleries](http://mypgc.co/portfolio-item/flagallery-videoblog-pro-skin/)
...
Copyright 2009 by MyPGC.co & CodEasily.com DevTeam
