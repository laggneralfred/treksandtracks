	...
	*/
	...
	function wp_flag_ins_button() {
		...
		<script type="text/javascript">
			...
			function wpflagins() {
				tb_show("<?php _e('Insert Flash Album with one or more galleries', 'flash-album-gallery'); ?>","<?php echo add_query_arg(array('action' => 'flag_shortcode_helper'), admin_url( 'admin-ajax.php' )); ?>&TB_iframe=true&width=640&height=310",false);
