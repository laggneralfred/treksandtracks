		...
		if ( !$filename ) {
			...
			if ( !empty($_FILES) ) {
                ...
                if(!wp_mkdir_p($skins_dir)) {
                    echo "<p>".sprintf(__('Unable to create directory %s. Is its parent directory writable by the server?', 'grand-media'), $skins_dir)."</p>\n";
                    echo '</div>';
                    return;
                }
                if(!is_writable($skins_dir)) {
                    ...
                    if(!is_writable($skins_dir)) {
                        ...
                        echo "<p>".sprintf(__('Directory %s is not writable by the server.', 'grand-media'), $skins_dir)."</p>\n";
                        echo '</div>';
                        return;
                    }
                }
