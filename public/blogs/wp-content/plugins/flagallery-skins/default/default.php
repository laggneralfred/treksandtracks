...
Skin Name: Midnight
Skin URI: 
Description: Default skin included in GRAND Flash Album Gallery plugin. <br /><br />Details: bottom thumbnails, fullscreen button (FS), slideshhow button (SL), backlink to PhotoGalleryCreator.com (PGC), image description button (i)
Author: PGC
