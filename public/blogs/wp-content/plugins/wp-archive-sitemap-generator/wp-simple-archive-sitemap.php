...
Plugin URI: http://crunchmeme.com/plugins/wp-archive-sitemap-generator/
...
function wp_archive_sitemap_generator($text) {
	...
	if (preg_match("|<!--wp-archive-sitemap-generator-->|", $text)) {
		...
		$pluginlink = "http://crunchmeme.com/plugins/wp-archive-sitemap-generator/";
		$target1 = "_blank";
		...
		{
			$sponsor_link1 = '<font size="1"><br/><i> Generated by: <a href="http://crunchmeme.com/plugins/wp-archive-sitemap-generator/" target="_blank">WP Archive-Sitemap Generator</a></i></font>';
		}

		$text = preg_replace("|<!--wp-archive-sitemap-generator-->|", '<b>'. $postheader .'</b>'. $pages . '' .$posts . $row1 . '<br />' . $pagedResult1 . $sponsor_link1 , $text);
	}
	...
	<br>
		...
		<div id="side-info-column" class="inner-sidebar">
			<div class="postbox">
			  ...
			  <div class="inside">
				<ul>
				<li><a href="http://crunchmeme.com/plugins/wp-archive-sitemap-generator/" title="WP Archive-Sitemap Generator" target="_blank">Plugin Homepage</a></li>
				<li>
			...
			<div id="side-info-column" class="inner-sidebar">
				<div class="postbox">
				  ...
				  <div class="inside">
					...
					<li>3) <a href="http://crunchmeme.com/plugins/twitter-goodies/" title="Twitter Goodies" target="_blank">Twitter Goodies</a></li>
					...
					<li>5) <a href="http://crunchmeme.com/plugins/facebook-members/" title="Facebook Members" target="_blank">Facebook Members</a></li>
